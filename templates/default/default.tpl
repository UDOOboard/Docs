...
<body>
    ...
    <!-- Homepage -->
        <div class="navbar navbar-fixed-top hidden-print">
            <div class="container">
                <a class="brand navbar-brand pull-left" href="<?php echo $index; ?>"><img src="http://udoo.org/docs/templates/default/themes/udoo/img/logo_docs.png" alt="" /><?php echo $project_title; ?></a>
        ...
        <div class="container-fluid fluid-height wrapper">
            <div class="navbar navbar-fixed-top hidden-print">
                <div class="container-fluid">
                    <a class="brand navbar-brand pull-left" href="http://udoo.org"><img src="http://udoo.org/docs/templates/default/themes/udoo/img/logo_docs.png" alt="" />   <?php echo $project_title; ?></a>
                    <p class="navbar-text pull-right">Generated by <a href="http://daux.io">Daux.io</a></p>
                </div>
            </div>
