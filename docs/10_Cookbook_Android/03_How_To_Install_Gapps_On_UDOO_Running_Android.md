...
You can easily install Google Apps in the newest Android 6.0.1 Marshmallow for UDOO QUAD/DUAL using the `Install from zip` function of the [TWRP recovery](https://twrp.me/) we provide with the image.
